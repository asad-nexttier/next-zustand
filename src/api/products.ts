...
const products = [
  {
    id: 1,
    image: "/assets/images/castle-t-shirt.jpg",
    name: "Castle T-Shirt",
    price: 25,
    description: "Beware the castle of the blue wizard of Bazmagar! It is said that he has a dragon!",
    reviews: [
      {
        rating: 5,
  ...
  {
    id: 2,
    image: "/assets/images/dragon-t-shirt.jpg",
    name: "Dragon T-Shirt",
    price: 25,
    description: "This dragon is not to be trifled with, his fire has burned many enemies to ash!",
    reviews: [
      {
        rating: 5,
  ...
  {
    id: 3,
    image: "/assets/images/elf-t-shirt.jpg",
    name: "Elf T-Shirt",
    price: 25,
    description: "This fierce elf is ready to take on any foe, with her trusty bow and arrow!",
    reviews: [
      {
        rating: 4,
  ...
  {
    id: 4,
    image: "/assets/images/wizard-t-shirt.jpg",
    name: "Wizard T-Shirt",
    price: 25,
    description: "This wizard is ready to cast a spell on you, and it won't be a good one!",
    reviews: [
      {
        rating: 5,
  ...
  {
    id: 5,
    image: "/assets/images/wizard-t-shirt-2.jpg",
    name: "Wizard T-Shirt ][",
    price: 25,
    description: "The wizard is powerful and knows many dangerous spells, beware traveller!",
    reviews: [
      {
        rating: 5,
  ...
  {
    id: 6,
    image: "/assets/images/barbarian-t-shirt.jpg",
    name: "Barbarian T-Shirt",
    price: 25,
    description: "This barbarian is ready to take on any foe, with his trusty broadsword!",
    reviews: [
      {
        rating: 4,
